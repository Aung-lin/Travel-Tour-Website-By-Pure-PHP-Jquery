...
if(isset($_POST['delete']))
{
    ...
    $confirmation = "<script>if(confirm('Are you sure you want to delete this data?')){document.location.href='AdminClients.php?id=$id';}</script>";
    echo $confirmation;
...
<html lang="en">
  <head>
    ...
    <title>Contact Control Panel</title>
  ...
  <body>
    ...
    <div class="span_1_of_5 sidenav">
      ...
      <div class="nav-items">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a id="seventhChild" href="dashboard2.php">
          ...
          <li class="nav-item">
            <a id="ninthChild" href="AdminClients.php">
              <span class="nav-link"
          ...
          <li class="nav-item">
            <a id="firstChild" href="Contact.php">
              <span class="nav-link"
...
<div class="clearfix"></div>
    ...
    <h2>Data Table | For Clients View</h2>
...
if($Run_SelectQuery){
  while($row= mysqli_fetch_array($Run_SelectQuery)){
    ...
    <td> <?php echo $row['NameOfInterview']; ?></td>
    <td> <?php echo $row['Subject']; ?></td>
    <td> <?php echo $row['CustomerID']; ?></td>
    <td> <?php echo $row['Question']; ?></td>
   
    <form class="" action="Contact.php" method="post" autocomplete="off" enctype="multipart/form-data">
    <input type="hidden" name="delid" value="<?php echo $row['ContactID'];?>">
    <td><button type="submit" name="delete" id="delete"><i class="fa-solid fa-user-slash"></i></button></td>
    </form>
    </tbody>
    <?php
