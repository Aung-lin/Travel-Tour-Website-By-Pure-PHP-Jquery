...
$SelectQuery = "SELECT * FROM packageType";
$Run_SelectQuery= mysqli_query($connect,$SelectQuery );


if(isset($_POST["BtnPKsubmit"])){


  $name = $_POST["Name"];

  
  $query ="INSERT into packageType(PackageTypeName) Values('$name')";
...
if(isset($_POST['delete']))
{
    ...
    $query = "DELETE FROM packageType WHERE PackageTypeID=$id ";
  ...
  <body>
    ...
    <div class="span_1_of_5 sidenav">
      ...
      <div class="nav-items">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a id="thirdChild" href="dashboard2.php">
          ...
          <li class="nav-item">
            <a id="firstChild" href="PackageType.php">
              <span class="nav-link"
      ...
      <li class="nav-item">
        <form action="PackageType.php" method="POST">
...
<div id="modalDialog" class="modal">
  <div class="modal-content animate-top">
    <div class="modal-header">
      <h5 class="modal-title">Add Data To PackageType Table</h5>
      <button type="button" class="close">
        <span aria-hidden="true">x</span>
      </button>
    </div>
    <div class="modal-body">
        <form class="" action="PackageType.php" method="post" autocomplete="off" enctype="multipart/form-data">
        
        <div class="col span_1_of_2 form-left">
        <label for="name">PackageTypeName </label>
        <br>
    ...
    <div class="modal-footer">
      ...
      <button type = "submit" class="btn btn-primary" name = "BtnPKsubmit">Submit</button>
    ...
    <h2>Data Table | For PackageType View</h2>
...
if($Run_SelectQuery){
  while($row= mysqli_fetch_array($Run_SelectQuery)){
    ...
    <td> <?php echo $row['PackageTypeName']; ?></td>
    
    
    <form class="" >
    <input type="hidden" name="id" value="<?php echo $row['PackageID'];?>">
    <td>
      <a href="http://localhost/L5%20ASSIGNMENT%20PJ/Admin/UpdatePackageType.php?PackageTypeID=<?= $row['PackageTypeID']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
      <!-- <button type="submit" name="update"  id="update"></button> -->
     </td>
    </form>
    <form class="" action="PackageType.php" method="post" autocomplete="off" enctype="multipart/form-data">
    <input type="hidden" name="delid" value="<?php echo $row['PackageTypeID'];?>">
